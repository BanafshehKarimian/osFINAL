...
int Thread::searchChildPid(int child_pid) {
...
////////
	...
	void Thread::incrementChildCount() {
    		childCount++;
	}

	void Thread::decrementChildCount() {
   		childCount--;
	}

	void Thread::initializeChildStatus(int child_pid) {
	...
	int Thread::getChildStatus(int child_pid) {
	...
	void Thread::setChildStatus(int child_pid, int status) {
	    // Search the index of the child
	    int index = searchChildPid(child_pid);
